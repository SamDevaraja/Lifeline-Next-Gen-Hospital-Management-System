...
const About = () => (
    <div className="min-h-screen" style={{ background: 'var(--luna-bg)' }}>
        ...
        <section className="py-8 relative overflow-hidden" style={{ background: 'var(--luna-nav-bg)' }}>
        ...
        <section className="py-8" style={{ background: 'var(--luna-bg)' }}>
        ...
        {/* Action Sector */}
        <section className="py-8 relative overflow-hidden" style={{ background: 'var(--luna-card)', borderTop: '1px solid var(--luna-border)' }}>
            ...
            <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                <h2 className="text-4xl md:text-5xl font-black mb-8 leading-tight tracking-tighter" style={{ color: 'var(--luna-text-main)' }}>Access Internal Clinical Network</h2>
                <p className="text-[20px] font-black mb-12 max-w-2xl mx-auto" style={{ color: 'var(--luna-text-main)', opacity: 0.9 }}>Authorized personnel only. Please ensure your session is secure.</p>
                <div className="flex justify-center gap-6">
                    <Link to="/login" className="btn-teal px-12 py-5 text-sm font-black uppercase tracking-widest shadow-2xl">

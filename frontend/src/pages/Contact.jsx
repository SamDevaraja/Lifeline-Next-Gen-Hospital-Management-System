...
const Contact = () => {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden" style={{ background: 'var(--luna-bg)' }}>
            ...
            <section className="pt-20 md:pt-24 pb-4 md:pb-6 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                        <h1 className="text-3xl md:text-5xl font-black mb-4 md:mb-6 leading-none tracking-tighter" style={{ color: 'var(--luna-text-main)' }}>
                            Professional <br className="hidden md:block" />
                            <span className="text-gradient">Clinical Support.</span>
                        </h1>
                        <p className="text-sm md:text-xl max-w-2xl mx-auto leading-relaxed font-bold tracking-tight opacity-70 md:opacity-80" style={{ color: 'var(--luna-text-main)' }}>
                            Staff-dedicated institutional communication platform providing secure internal bridges for clinical inquiries and technical coordination.
                        </p>
                    </motion.div>
                </div>
            </section>
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-4">
                                    <div className="flex items-center gap-4 md:gap-5">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[9px] md:text-[11px] font-black opacity-60 uppercase tracking-[0.25em]" style={{ color: 'var(--luna-teal)' }}>Encrypted Handshake</p>
                                        </div>
                                    </div>
                                    <div className="flex flex-row sm:flex-col items-center sm:items-end justify-between sm:justify-center gap-2 border-t sm:border-t-0 pt-4 sm:pt-0" style={{ borderColor: 'var(--luna-border)' }}>
                                        <div className="badge-live px-3 md:px-4 py-1.5 text-[8px] md:text-[10px] shadow-sm font-black border-blue-500/20">Protocol ACTIVE</div>
                                        <p className="text-[8px] md:text-[9px] font-black opacity-30 uppercase tracking-widest" style={{ color: 'var(--luna-text-main)' }}>Latency: 12ms</p>
                                    </div>
                                </div>
                                    ...
                                    <div className="space-y-6 flex flex-col">
                                        ...
                                        <div className="p-6 rounded-2xl bg-blue-500/[0.02] border border-blue-500/10 space-y-4 flex-1">
                                            ...
                                            <CustomSelect 
                                                ...
                                                options={['Emergency', 'Integration', 'Technical Registry']}
                    ...
                    <div className="flex items-center justify-between mb-8 border-l-4 border-blue-500 pl-4">
                        <div>
                            <h2 className="text-xl md:text-2xl font-black tracking-tighter" style={{ color: 'var(--luna-text-main)' }}>
                                Clinical <span className="text-gradient">FAQ</span>
                            </h2>
                            <p className="text-[8px] md:text-[9px] font-bold opacity-30 uppercase tracking-[0.2em] mt-0.5" style={{ color: 'var(--luna-text-muted)' }}>Protocols v3.5</p>
                        </div>
                    </div>

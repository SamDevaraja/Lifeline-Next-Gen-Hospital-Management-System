    ...
    return (
        <div className="overflow-x-hidden">
            ...
            <section className="relative min-h-screen flex items-center overflow-hidden pt-44 md:pt-52"
                ...
                <div className="max-w-7xl mx-auto px-6 py-24 w-full relative z-20">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, ease: "easeOut" }}>
                            ...
                            <p className="text-lg mb-10 leading-relaxed max-w-xl font-bold" style={{ color: 'var(--luna-text-main)', opacity: 0.9 }}>
                                {t('heroDesc')} Precise, accessible, and trusted by medical professionals worldwide.
                            </p>

                            <div className="flex flex-wrap items-center gap-5 mb-20">
                                <Link to="/patient/login" id="hero-launch-btn" className="btn-teal px-10 py-4 text-base">
...
const FeaturesSection = () => {
    ...
    return (
        <section ref={ref} className="py-28" style={{ background: 'var(--luna-bg)' }}>
...
const TestimonialsSection = () => {
    ...
    return (
        <section ref={ref} className="py-28" style={{ background: 'var(--luna-bg)' }}>
            <div className="max-w-7xl mx-auto px-6">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} className="text-center mb-20">
    ...
    <section className="py-24 relative overflow-hidden"
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            ...
            <p className="text-lg mb-12 font-bold max-w-2xl mx-auto" style={{ color: 'var(--luna-text-main)', opacity: 0.9 }}>
                Join 500+ healthcare facilities using Lifeline to deliver better patient care every day.
            </p>
            <div className="flex flex-wrap gap-6 justify-center">
                <Link to="/patient/signup" id="cta-signup-btn" className="btn-teal px-12 py-5 text-lg">

...
import {
    Activity, AlertCircle, CheckCircle, X, UploadCloud, FileText, ChevronRight
} from 'lucide-react';
...
const DetailsModal = ({ isOpen, title, data, onCancel }) => {
    ...
    const formatValue = (key, val) => {
        ...
        if (key.includes('price') || key.includes('fee') || key.includes('amount')) return `₹${parseFloat(val).toLocaleString()}`;
        return String(val);
    };

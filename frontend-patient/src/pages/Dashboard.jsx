    ...
    return [
        {
            ...
            items: [
                { to: '/dashboard', icon: <LayoutDashboard className="w-5 h-5" />, label: 'My Health Hub', exact: true },
            ]
        },
        {
            title: 'Medical Services',
            items: [
                { to: '/dashboard/appointments', icon: <Calendar className="w-5 h-5" />, label: 'My Appointments' },
                { to: '/dashboard/records', icon: <FileText className="w-5 h-5" />, label: 'Health Records' },
                { to: '/dashboard/lab', icon: <FlaskConical className="w-5 h-5" />, label: 'Lab Results' },
            ]
        },
        {
            title: 'Intelligence & Finance',
            items: [
                { to: '/dashboard/billing', icon: <DollarSign className="w-5 h-5" />, label: 'My Bills' }
            ]
        }
    ];
};
